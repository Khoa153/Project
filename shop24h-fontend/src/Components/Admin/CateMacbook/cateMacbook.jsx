...
import '../../../App.css';
import CreateModalMacbook from "./modalCreateIMacbook";
import UpdateModalMacbook from "./modalUpdateIphone";
...
const CateMacbook = () => {
    ...
    const fetchGetAll = async () => {
        try {
            ...
            const cateIphone = data.cateMacbook
        ...
        <Container>
            <Grid container mt={5}>
                <div className="header-admin">
                    <h1 className="h1-order">Danh sách Sản Phẩm Macbook </h1>
