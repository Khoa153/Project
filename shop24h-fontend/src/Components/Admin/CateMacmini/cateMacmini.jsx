...
import '../../../App.css';
import CreateModalMacmini from './modalCreateMacmini'
import UpdateModalMacmini from './modalUpdateIMacmini'
...
const CateMacmini = () => {
    ...
    const fetchGetAll = async () => {
        try {
            ...
            const cateIphone = data.cateMacmini
        ...
        <Container>
            <Grid container mt={5}>
                <div className="header-admin">
                    <h1 className="h1-order">Danh sách Sản Phẩm Macmini </h1>
