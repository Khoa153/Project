...
import '../../../App.css';
import CreateModalAirpod from "./modalCreateAirpod";
import UpdateModalAirpod from "./modalUpdateAirpod";
...
const CateAirpod = () => {
    ...
    const fetchGetAll = async () => {
        try {
            ...
            const cateIphone = data.cateAirpod
        ...
        <Container>
            <Grid container mt={5}>
                <div className="header-admin">
                    <h1 className="h1-order">Danh sách Sản Phẩm Airpods </h1>
